...
CREATE TABLE "FieldIlluminationOutput" (
	...
	PRIMARY KEY (processing_application, processing_version, processing_entity, processing_datetime, processing_log, warnings, errors, validated, validation_datetime, comment, key_values, intensity_profiles, roi_profiles, roi_corners, roi_centers_of_mass, roi_centers_geometric, roi_centers_fitted, roi_centers_max_intensity, roi_center_region)
);
