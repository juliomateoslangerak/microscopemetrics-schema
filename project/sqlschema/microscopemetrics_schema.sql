...
--     * Slot: Experimenter_id Description: Autocreated FK slot
...
--     * Slot: name Description: The human readable name of an entity
--     * Slot: description Description: A human readable description of an entity
--     * Slot: preparation_protocol_id Description: The protocol used to prepare a sample
...
--     * Slot: id
--     * Slot: comment_datetime Description: The datetime to which the comment is referring
--     * Slot: comment_type Description: The type of the comment
--     * Slot: text Description: The text of the comment
--     * Slot: name Description: The human readable name of an entity
--     * Slot: description Description: A human readable description of an entity
--     * Slot: author_id Description: The author of the comment
--     * Slot: data_reference_id Description: A reference to the data
...
--     * Slot: experimenter_id Description: The experimenter that performed the imaging experiment
--     * Slot: acquisition_protocol_id Description: The protocol used to acquire the dataset
--     * Slot: data_reference_id Description: A reference to the data
...
--     * Slot: authors_id Description: The authors of the protocol
...
CREATE INDEX "ix_Experimenter_id" ON "Experimenter" (id);
...
CREATE TABLE "Comment" (
	...
	data_reference_id INTEGER,
	PRIMARY KEY (id),
	FOREIGN KEY(author_id) REFERENCES "Experimenter" (id),
	FOREIGN KEY(data_reference_id) REFERENCES "DataReference" (id)
);
...
CREATE TABLE "MetricsDataset" (
	...
	experimenter_id INTEGER,
	acquisition_protocol_id INTEGER,
	data_reference_id INTEGER,
	PRIMARY KEY (id),
	FOREIGN KEY("MetricsDatasetCollection_id") REFERENCES "MetricsDatasetCollection" (id),
	FOREIGN KEY("HarmonizedMetricsDatasetCollection_id") REFERENCES "HarmonizedMetricsDatasetCollection" (id),
	...
	FOREIGN KEY(microscope_id) REFERENCES "Microscope" (id),
	FOREIGN KEY(experimenter_id) REFERENCES "Experimenter" (id),
	FOREIGN KEY(acquisition_protocol_id) REFERENCES "Protocol" (id),
	FOREIGN KEY(data_reference_id) REFERENCES "DataReference" (id)
);
...
CREATE TABLE "Sample" (
	...
	name TEXT,
	description TEXT,
	preparation_protocol_id INTEGER NOT NULL,
	PRIMARY KEY (id),
	FOREIGN KEY(preparation_protocol_id) REFERENCES "Protocol" (id)
);
...
CREATE INDEX "ix_MicroscopeCollection_microscope_collection_microscope_collection_id" ON "MicroscopeCollection_microscope_collection" (microscope_collection_id);
CREATE INDEX "ix_MicroscopeCollection_microscope_collection_MicroscopeCollection_id" ON "MicroscopeCollection_microscope_collection" ("MicroscopeCollection_id");
...
CREATE TABLE "Protocol_authors" (
	"Protocol_id" INTEGER,
	authors_id INTEGER,
	PRIMARY KEY ("Protocol_id", authors_id),
...
CREATE INDEX "ix_MetricsOutput_processing_entity_processing_entity" ON "MetricsOutput_processing_entity" (processing_entity);
CREATE INDEX "ix_MetricsOutput_processing_entity_MetricsOutput_id" ON "MetricsOutput_processing_entity" ("MetricsOutput_id");
...
CREATE INDEX "ix_TimeSeries_time_points_sec_time_points_sec" ON "TimeSeries_time_points_sec" (time_points_sec);
CREATE INDEX "ix_TimeSeries_time_points_sec_TimeSeries_id" ON "TimeSeries_time_points_sec" ("TimeSeries_id");
...
CREATE INDEX "ix_FieldIlluminationOutput_processing_application_processing_application" ON "FieldIlluminationOutput_processing_application" (processing_application);
CREATE INDEX "ix_FieldIlluminationOutput_processing_application_FieldIlluminationOutput_id" ON "FieldIlluminationOutput_processing_application" ("FieldIlluminationOutput_id");
...
CREATE INDEX "ix_FieldIlluminationOutput_processing_version_processing_version" ON "FieldIlluminationOutput_processing_version" (processing_version);
CREATE INDEX "ix_FieldIlluminationOutput_processing_version_FieldIlluminationOutput_id" ON "FieldIlluminationOutput_processing_version" ("FieldIlluminationOutput_id");
...
CREATE INDEX "ix_FieldIlluminationOutput_processing_entity_processing_entity" ON "FieldIlluminationOutput_processing_entity" (processing_entity);
CREATE INDEX "ix_FieldIlluminationOutput_processing_entity_FieldIlluminationOutput_id" ON "FieldIlluminationOutput_processing_entity" ("FieldIlluminationOutput_id");
...
CREATE INDEX "ix_PSFBeadsOutput_processing_application_processing_application" ON "PSFBeadsOutput_processing_application" (processing_application);
CREATE INDEX "ix_PSFBeadsOutput_processing_application_PSFBeadsOutput_id" ON "PSFBeadsOutput_processing_application" ("PSFBeadsOutput_id");
...
CREATE INDEX "ix_PSFBeadsOutput_processing_version_processing_version" ON "PSFBeadsOutput_processing_version" (processing_version);
CREATE INDEX "ix_PSFBeadsOutput_processing_version_PSFBeadsOutput_id" ON "PSFBeadsOutput_processing_version" ("PSFBeadsOutput_id");
...
CREATE INDEX "ix_LightSourcePowerOutput_processing_entity_LightSourcePowerOutput_id" ON "LightSourcePowerOutput_processing_entity" ("LightSourcePowerOutput_id");
CREATE INDEX "ix_LightSourcePowerOutput_processing_entity_processing_entity" ON "LightSourcePowerOutput_processing_entity" (processing_entity);
...
CREATE INDEX "ix_LightSourcePowerOutput_warnings_LightSourcePowerOutput_id" ON "LightSourcePowerOutput_warnings" ("LightSourcePowerOutput_id");
CREATE INDEX "ix_LightSourcePowerOutput_warnings_warnings" ON "LightSourcePowerOutput_warnings" (warnings);
...
CREATE INDEX "ix_UserExperimentOutput_warnings_warnings" ON "UserExperimentOutput_warnings" (warnings);
CREATE INDEX "ix_UserExperimentOutput_warnings_UserExperimentOutput_id" ON "UserExperimentOutput_warnings" ("UserExperimentOutput_id");
