...
--     * Slot: id Description: 
--     * Slot: average_bead_fit_r2_z Description: Average coefficient of determination (R^2) for the fits in the Z axis of the beads.
--     * Slot: average_bead_fit_r2_y Description: Average coefficient of determination (R^2) for the fits in the Y axis of the beads.
--     * Slot: average_bead_fit_r2_x Description: Average coefficient of determination (R^2) for the fits in the X axis of the beads.
--     * Slot: average_bead_fwhm_pixel_z Description: FWHM for the average bead in the Z axis in pixels.
--     * Slot: average_bead_fwhm_pixel_y Description: FWHM for the average bead in the Y axis in pixels.
--     * Slot: average_bead_fwhm_pixel_x Description: FWHM for the average bead in the X axis in pixels.
--     * Slot: average_bead_fwhm_micron_z Description: Average FWHM for the beads in the Z axis in microns.
--     * Slot: average_bead_fwhm_micron_y Description: FWHM for the average bead in the Y axis in microns.
--     * Slot: average_bead_fwhm_micron_x Description: FWHM for the average bead in the X axis in microns.
--     * Slot: average_bead_fwhm_lateral_asymmetry_ratio Description: Lateral FWHM asymmetry ratio for the average bead.
--     * Slot: name Description: The human readable name of an entity
--     * Slot: description Description: A human readable description of an entity
--     * Slot: data_reference_id Description: A reference to the data
