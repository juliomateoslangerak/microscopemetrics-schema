...
class FieldIlluminationKeyMeasurement(KeyMeasurement):
    ...
    center_of_mass_distance_relative: Optional[float] = Field(default=None, description="""The relative distance of the centers of mass to the center of the image. Relative to the distance to an image edge. 1.0 is centered, 0.0 is at the lateral edge. Negative values when center is towards the corner of the image.""", ge=-1.0, le=1.0, json_schema_extra = { "linkml_meta": {'domain_of': ['FieldIlluminationKeyMeasurement']} })
    ...
    center_geometric_distance_relative: Optional[float] = Field(default=None, description="""The relative distance of the geometric center to the center of the image. Relative to the distance to an image edge. 1.0 is centered, 0.0 is at the lateral edge. Negative values when center is towards the corner of the image.""", ge=-1.0, le=1.0, json_schema_extra = { "linkml_meta": {'domain_of': ['FieldIlluminationKeyMeasurement']} })
    ...
    center_fitted_distance_relative: Optional[float] = Field(default=None, description="""The relative distance of the fitted center of illumination to the center of the image. Relative to the distance to an image edge. 1.0 is centered, 0.0 is at the lateral edge. Negative values when center is towards the corner of the image.""", ge=-1.0, le=1.0, json_schema_extra = { "linkml_meta": {'domain_of': ['FieldIlluminationKeyMeasurement']} })
    ...
    max_min_intensity_ratio: Optional[float] = Field(default=None, description="""The intensity ratio between the maximum and minimum intensity (min_int/max_int).""", ge=0.0, le=1.0, json_schema_extra = { "linkml_meta": {'domain_of': ['FieldIlluminationKeyMeasurement']} })
    mean_corner_intensity_ratio: Optional[float] = Field(default=None, description="""The intensity ratio between the center of illumination and the mean of all four corners.""", ge=0.0, le=1.0, json_schema_extra = { "linkml_meta": {'domain_of': ['FieldIlluminationKeyMeasurement']} })
    min_corner_intensity_ratio: Optional[float] = Field(default=None, description="""The intensity ratio between the center of illumination and the lowest intensity corner.""", ge=0.0, le=1.0, json_schema_extra = { "linkml_meta": {'domain_of': ['FieldIlluminationKeyMeasurement']} })
    ...
    max_intensity_distance_relative: Optional[float] = Field(default=None, description="""The relative distance of the maximum intensity to the center of the image. Relative to the distance to an image edge. 1.0 is centered, 0.0 is at the lateral edge. Negative values when center is towards the corner of the image.""", ge=-1.0, le=1.0, json_schema_extra = { "linkml_meta": {'domain_of': ['FieldIlluminationKeyMeasurement']} })
...
class PSFBeadsKeyMeasurement(KeyMeasurement):
    ...
    considered_lateral_edge_count: Optional[int] = Field(default=None, description="""Number of beads considered for being too close to the edge of the image. One value per channel.""", json_schema_extra = { "linkml_meta": {'domain_of': ['PSFBeadsKeyMeasurement', 'CoRegistrationKeyMeasurement']} })
    ...
    considered_intensity_std_outlier_count: Optional[int] = Field(default=None, description="""Number of beads considered as being too intense and potentially represent a cluster of beads. These beads have a robust z-score over the requested threshold for the standard deviation of the intensity. Measurements on these beads are not averaged into the key measurements. One value per channel.""", json_schema_extra = { "linkml_meta": {'domain_of': ['PSFBeadsKeyMeasurement']} })
    ...
    fwhm_axial_asymmetry_ratio_mean: Optional[float] = Field(default=None, description="""Mean axial FWHM asymmetry ratio for the analyzed beads. One value per channel.""", json_schema_extra = { "linkml_meta": {'domain_of': ['PSFBeadsKeyMeasurement']} })
    fwhm_axial_asymmetry_ratio_median: Optional[float] = Field(default=None, description="""Median axial FWHM asymmetry ratio for the analyzed beads. One value per channel.""", json_schema_extra = { "linkml_meta": {'domain_of': ['PSFBeadsKeyMeasurement']} })
    fwhm_axial_asymmetry_ratio_std: Optional[float] = Field(default=None, description="""Standard deviation of the lateral FWHM asymmetry ratio for the analyzed beads. One value per channel.""", json_schema_extra = { "linkml_meta": {'domain_of': ['PSFBeadsKeyMeasurement']} })
    ...
    average_bead_fwhm_axial_asymmetry_ratio: Optional[float] = Field(default=None, description="""Axial FWHM asymmetry ratio for the average bead. One value per channel.""", json_schema_extra = { "linkml_meta": {'domain_of': ['PSFBeadsKeyMeasurement']} })
...
class StageDriftKeyMeasurement(KeyMeasurement):
    ...
    relative_position_pixel_x_mean: Optional[float] = Field(default=None, description="""The mean relative position of the stage in x in pixels.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    relative_position_pixel_x_median: Optional[float] = Field(default=None, description="""The median relative position of the stage in x in pixels.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    relative_position_pixel_x_std: Optional[float] = Field(default=None, description="""The standard deviation of the relative position of the stage in x in pixels.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    relative_position_pixel_y_mean: Optional[float] = Field(default=None, description="""The mean relative position of the stage in y in pixels.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    relative_position_pixel_y_median: Optional[float] = Field(default=None, description="""The median relative position of the stage in y in pixels.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    relative_position_pixel_y_std: Optional[float] = Field(default=None, description="""The standard deviation of the relative position of the stage in y in pixels.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    relative_position_pixel_z_mean: Optional[float] = Field(default=None, description="""The mean relative position of the stage in z in pixels.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    relative_position_pixel_z_median: Optional[float] = Field(default=None, description="""The median relative position of the stage in z in pixels.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    relative_position_pixel_z_std: Optional[float] = Field(default=None, description="""The standard deviation of the relative position of the stage in z in pixels.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    relative_position_micron_x_mean: Optional[float] = Field(default=None, description="""The mean relative position of the stage in x in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    relative_position_micron_x_median: Optional[float] = Field(default=None, description="""The median relative position of the stage in x in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    relative_position_micron_x_std: Optional[float] = Field(default=None, description="""The standard deviation of the relative position of the stage in x in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    relative_position_micron_y_mean: Optional[float] = Field(default=None, description="""The mean relative position of the stage in y in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    relative_position_micron_y_median: Optional[float] = Field(default=None, description="""The median relative position of the stage in y in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    relative_position_micron_y_std: Optional[float] = Field(default=None, description="""The standard deviation of the relative position of the stage in y in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    relative_position_micron_z_mean: Optional[float] = Field(default=None, description="""The mean relative position of the stage in z in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    relative_position_micron_z_median: Optional[float] = Field(default=None, description="""The median relative position of the stage in z in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    relative_position_micron_z_std: Optional[float] = Field(default=None, description="""The standard deviation of the relative position of the stage in z in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    displacement_pixel_x_mean: Optional[float] = Field(default=None, description="""The mean absolute displacement of the stage in x in pixels.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    displacement_pixel_x_median: Optional[float] = Field(default=None, description="""The median absolute displacement of the stage in x in pixels.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    displacement_pixel_x_std: Optional[float] = Field(default=None, description="""The standard deviation of the absolute displacement of the stage in x in pixels.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    displacement_pixel_y_mean: Optional[float] = Field(default=None, description="""The mean absolute displacement of the stage in y in pixels.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    displacement_pixel_y_median: Optional[float] = Field(default=None, description="""The median absolute displacement of the stage in y in pixels.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    displacement_pixel_y_std: Optional[float] = Field(default=None, description="""The standard deviation of the absolute displacement of the stage in y in pixels.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    displacement_pixel_z_mean: Optional[float] = Field(default=None, description="""The mean absolute displacement of the stage in z in pixels.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    displacement_pixel_z_median: Optional[float] = Field(default=None, description="""The median absolute displacement of the stage in z in pixels.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    displacement_micron_x_mean: Optional[float] = Field(default=None, description="""The mean absolute displacement of the stage in x in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    displacement_micron_x_median: Optional[float] = Field(default=None, description="""The median absolute displacement of the stage in x in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    displacement_micron_x_std: Optional[float] = Field(default=None, description="""The standard deviation of the absolute displacement of the stage in x in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    displacement_micron_y_mean: Optional[float] = Field(default=None, description="""The mean absolute displacement of the stage in y in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    displacement_micron_y_median: Optional[float] = Field(default=None, description="""The median absolute displacement of the stage in y in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    displacement_micron_y_std: Optional[float] = Field(default=None, description="""The standard deviation of the absolute displacement of the stage in y in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    displacement_micron_z_mean: Optional[float] = Field(default=None, description="""The mean absolute displacement of the stage in z in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    displacement_micron_z_median: Optional[float] = Field(default=None, description="""The median absolute displacement of the stage in z in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    displacement_micron_z_std: Optional[float] = Field(default=None, description="""The standard deviation of the absolute displacement of the stage in z in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    displacement_micron_3d_mean: Optional[float] = Field(default=None, description="""The mean absolute displacement of the stage in 3d in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    displacement_micron_3d_median: Optional[float] = Field(default=None, description="""The median absolute displacement of the stage in 3d in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    displacement_micron_3d_std: Optional[float] = Field(default=None, description="""The standard deviation of the absolute displacement of the stage in 3d in microns.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_pixel_x_mean: Optional[float] = Field(default=None, description="""The velocity at which the stage moves in x in pixels per second""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_pixel_x_median: Optional[float] = Field(default=None, description="""The median velocity at which the stage moves in x in pixels per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_pixel_x_std: Optional[float] = Field(default=None, description="""The standard deviation of the velocity at which the stage moves in x in pixels per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_pixel_y_mean: Optional[float] = Field(default=None, description="""The mean velocity at which the stage moves in y in pixels per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_pixel_y_median: Optional[float] = Field(default=None, description="""The median velocity at which the stage moves in y in pixels per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_pixel_y_std: Optional[float] = Field(default=None, description="""The standard deviation of the velocity at which the stage moves in y in pixels per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_pixel_z_mean: Optional[float] = Field(default=None, description="""The mean velocity at which the stage moves in z in pixels per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_pixel_z_median: Optional[float] = Field(default=None, description="""The median velocity at which the stage moves in z in pixels per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_x_mean: Optional[float] = Field(default=None, description="""The mean velocity at which the stage moves in x in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_x_median: Optional[float] = Field(default=None, description="""The median velocity at which the stage moves in x in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_x_std: Optional[float] = Field(default=None, description="""The standard deviation of the velocity at which the stage moves in x in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_y_mean: Optional[float] = Field(default=None, description="""The mean velocity at which the stage moves in y in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_y_median: Optional[float] = Field(default=None, description="""The median velocity at which the stage moves in y in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_y_std: Optional[float] = Field(default=None, description="""The standard deviation of the velocity at which the stage moves in y in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_z_mean: Optional[float] = Field(default=None, description="""The mean velocity at which the stage moves in z in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_z_median: Optional[float] = Field(default=None, description="""The median velocity at which the stage moves in z in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_z_std: Optional[float] = Field(default=None, description="""The standard deviation of the velocity at which the stage moves in z in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_3d_mean: Optional[float] = Field(default=None, description="""The mean velocity at which the stage moves in 3d in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_3d_median: Optional[float] = Field(default=None, description="""The median velocity at which the stage moves in 3d in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_3d_std: Optional[float] = Field(default=None, description="""The standard deviation of the velocity at which the stage moves in 3d in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
