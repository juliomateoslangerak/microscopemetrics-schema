...
class StageDriftKeyMeasurement(KeyMeasurement):
    ...
    displacement_pixel_z_std: Optional[float] = Field(default=None, description="""The standard deviation of the absolute displacement of the stage in z in pixels.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    ...
    velocity_micron_per_sec_x_mean: Optional[float] = Field(default=None, description="""The mean velocity at which the stage moves in x in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_per_sec_x_median: Optional[float] = Field(default=None, description="""The median velocity at which the stage moves in x in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_per_sec_x_std: Optional[float] = Field(default=None, description="""The standard deviation of the velocity at which the stage moves in x in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_per_sec_y_mean: Optional[float] = Field(default=None, description="""The mean velocity at which the stage moves in y in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_per_sec_y_median: Optional[float] = Field(default=None, description="""The median velocity at which the stage moves in y in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_per_sec_y_std: Optional[float] = Field(default=None, description="""The standard deviation of the velocity at which the stage moves in y in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_per_sec_z_mean: Optional[float] = Field(default=None, description="""The mean velocity at which the stage moves in z in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_per_sec_z_median: Optional[float] = Field(default=None, description="""The median velocity at which the stage moves in z in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_per_sec_z_std: Optional[float] = Field(default=None, description="""The standard deviation of the velocity at which the stage moves in z in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_per_sec_3d_mean: Optional[float] = Field(default=None, description="""The mean velocity at which the stage moves in 3d in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_per_sec_3d_median: Optional[float] = Field(default=None, description="""The median velocity at which the stage moves in 3d in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
    velocity_micron_per_sec_3d_std: Optional[float] = Field(default=None, description="""The standard deviation of the velocity at which the stage moves in 3d in microns per second.""", json_schema_extra = { "linkml_meta": {'domain_of': ['StageDriftKeyMeasurement']} })
