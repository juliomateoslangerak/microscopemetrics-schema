...
def st_mm_field_illumination_key_measurement(
    ...
    max_min_intensity_ratio=st.just(0.5),
    mean_corner_intensity_ratio=st.just(0.8),
    min_corner_intensity_ratio=st.just(0.5),
    ...
    return mm_schema.FieldIlluminationKeyMeasurement(
        ...
        max_min_intensity_ratio=draw(max_min_intensity_ratio),
        mean_corner_intensity_ratio=draw(mean_corner_intensity_ratio),
        min_corner_intensity_ratio=draw(min_corner_intensity_ratio),
