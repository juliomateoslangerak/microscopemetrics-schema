...
def st_mm_stage_drift_key_measurement(
    ...
    velocity_pixel_x_mean=st.just(0.5),
    velocity_pixel_x_median=st.just(0.5),
    velocity_pixel_x_std=st.just(0.5),
    velocity_pixel_y_mean=st.just(0.5),
    velocity_pixel_y_median=st.just(0.5),
    velocity_pixel_y_std=st.just(0.5),
    velocity_pixel_z_mean=st.just(0.5),
    velocity_pixel_z_median=st.just(0.5),
    velocity_micron_x_mean=st.just(0.5),
    velocity_micron_x_median=st.just(0.5),
    velocity_micron_x_std=st.just(0.5),
    velocity_micron_y_mean=st.just(0.5),
    velocity_micron_y_median=st.just(0.5),
    velocity_micron_y_std=st.just(0.5),
    velocity_micron_z_mean=st.just(0.5),
    velocity_micron_z_median=st.just(0.5),
    velocity_micron_z_std=st.just(0.5),
    velocity_micron_3d_mean=st.just(0.5),
    velocity_micron_3d_median=st.just(0.5),
    velocity_micron_3d_std=st.just(0.5),
    ...
    return mm_schema.StageDriftKeyMeasurement(
        ...
        velocity_pixel_x_mean=draw(velocity_pixel_x_mean),
        velocity_pixel_x_median=draw(velocity_pixel_x_median),
        velocity_pixel_x_std=draw(velocity_pixel_x_std),
        velocity_pixel_y_mean=draw(velocity_pixel_y_mean),
        velocity_pixel_y_median=draw(velocity_pixel_y_median),
        velocity_pixel_y_std=draw(velocity_pixel_y_std),
        velocity_pixel_z_mean=draw(velocity_pixel_z_mean),
        velocity_pixel_z_median=draw(velocity_pixel_z_median),
        velocity_micron_x_mean=draw(velocity_micron_x_mean),
        velocity_micron_x_median=draw(velocity_micron_x_median),
        velocity_micron_x_std=draw(velocity_micron_x_std),
        velocity_micron_y_mean=draw(velocity_micron_y_mean),
        velocity_micron_y_median=draw(velocity_micron_y_median),
        velocity_micron_y_std=draw(velocity_micron_y_std),
        velocity_micron_z_mean=draw(velocity_micron_z_mean),
        velocity_micron_z_median=draw(velocity_micron_z_median),
        velocity_micron_z_std=draw(velocity_micron_z_std),
        velocity_micron_3d_mean=draw(velocity_micron_3d_mean),
        velocity_micron_3d_median=draw(velocity_micron_3d_median),
        velocity_micron_3d_std=draw(velocity_micron_3d_std),
