...
def st_mm_psf_beads_key_measurement(
    ...
    considered_intensity_std_outlier_count=st.just(1),
    ...
    fwhm_axial_asymmetry_ratio_mean=st.just(1.1),
    fwhm_axial_asymmetry_ratio_median=st.just(1.1),
    fwhm_axial_asymmetry_ratio_std=st.just(0.02),
    ...
    average_bead_fwhm_axial_asymmetry_ratio=st.just(1.1),
    ...
    return mm_schema.PSFBeadsKeyMeasurement(
        ...
        considered_intensity_std_outlier_count=draw(considered_intensity_std_outlier_count),
        ...
        fwhm_axial_asymmetry_ratio_mean=draw(fwhm_axial_asymmetry_ratio_mean),
        fwhm_axial_asymmetry_ratio_median=draw(fwhm_axial_asymmetry_ratio_median),
        fwhm_axial_asymmetry_ratio_std=draw(fwhm_axial_asymmetry_ratio_std),
        ...
        average_bead_fwhm_axial_asymmetry_ratio=draw(average_bead_fwhm_axial_asymmetry_ratio),
