...
def st_mm_psf_beads_key_measurement(
    ...
    considered_bad_fit_z_count=st.just(0),
    considered_bad_fit_y_count=st.just(0),
    considered_bad_fit_x_count=st.just(0),
    ...
    fit_r2_z_mean=st.just(0.80),
    fit_r2_z_median=st.just(0.80),
    fit_r2_z_std=st.just(0.02),
    fit_r2_y_mean=st.just(0.85),
    fit_r2_y_median=st.just(0.85),
    fit_r2_y_std=st.just(0.01),
    fit_r2_x_mean=st.just(0.85),
    fit_r2_x_median=st.just(0.86),
    fit_r2_x_std=st.just(0.03),
    ...
    average_bead_fit_r2_z=st.just(0.85),
    average_bead_fit_r2_y=st.just(0.86),
    average_bead_fit_r2_x=st.just(0.90),
    ...
    return mm_schema.PSFBeadsKeyMeasurement(
        ...
        considered_bad_fit_z_count=draw(considered_bad_fit_z_count),
        considered_bad_fit_y_count=draw(considered_bad_fit_y_count),
        considered_bad_fit_x_count=draw(considered_bad_fit_x_count),
        ...
        fit_r2_z_mean=draw(fit_r2_z_mean),
        fit_r2_z_median=draw(fit_r2_z_median),
        fit_r2_z_std=draw(fit_r2_z_std),
        fit_r2_y_mean=draw(fit_r2_y_mean),
        fit_r2_y_median=draw(fit_r2_y_median),
        fit_r2_y_std=draw(fit_r2_y_std),
        fit_r2_x_mean=draw(fit_r2_x_mean),
        fit_r2_x_median=draw(fit_r2_x_median),
        fit_r2_x_std=draw(fit_r2_x_std),
        ...
        average_bead_fit_r2_z=draw(average_bead_fit_r2_z),
        average_bead_fit_r2_y=draw(average_bead_fit_r2_y),
        average_bead_fit_r2_x=draw(average_bead_fit_r2_x),
