# Contributing to microscopemetrics-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
microscopemetrics-schema. These guidelines are not strict rules.
...
The microscopemetrics-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the microscopemetrics-schema technical leads
...
[issues]: https://github.com/MontpellierRessourcesImagerie/microscopemetrics-schema/issues/
[pulls]: https://github.com/MontpellierRessourcesImagerie/microscopemetrics-schema/pulls/
